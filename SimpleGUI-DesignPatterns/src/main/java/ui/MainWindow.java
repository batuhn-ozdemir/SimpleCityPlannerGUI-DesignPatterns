...
public class MainWindow extends Application implements WeatherObserver {
    ...
    public void start(Stage stage) {
        ...
        xAxis.setCategories(FXCollections.observableArrayList(
                Arrays.asList("Ankara", "Buhara", "Gaziantep", "Gazze", "Isfahan",
                        "Islamabad", "Istanbul", "Kudüs", "Saraybosna", "Uskup", "Şam")
        ));
